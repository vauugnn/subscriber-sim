...
_SUBSCRIBER_OPENER_REMINDERS = {
    "horny": (
        ...
        "you want, use explicit language and sexual emojis. 1-2 sentences. Casual texting style. Just the message.\n"
        ...
        "✗ \"hi how are you?\" — too polite, not sexual\n"
        "✗ \"where are you from?\" — conversational, not horny"
    ),
    "cheapskate": (
        ...
        "a deal, question the cost, or hint you want something free. Lead with the discount angle. "
        ...
        "EXAMPLES OF WRONG OPENERS (DO NOT GENERATE):\n"
        "✗ \"hey ur so beautiful\" — too complimentary, forgets about price\n"
        "✗ \"i love your content\" — never mentions wanting a discount"
    ),
    "casual": (
        "TASK: Write your FIRST opening DM to Jasmin. You just found her page and you're "
    ...
    "troll": (
        ...
        "Open with skepticism and mockery — question if she's real, call her a catfish or bot, be "
        "sarcastic and provocative. 1-2 sentences. Lowercase, mocking tone. Just the message.\n"
        "EXAMPLES OF CORRECT OPENERS:\n"
        ...
        "EXAMPLES OF WRONG OPENERS (DO NOT GENERATE):\n"
        "✗ \"hey how are you\" — friendly, not skeptical\n"
        "✗ \"ur so beautiful\" — complimentary, not trolling"
    ),
    "whale": (
        ...
        "it CLEAR money is not an issue. Confident, no haggling. 1-2 sentences. Just the message.\n"
        "EXAMPLES OF CORRECT OPENERS:\n"
        ...
        "EXAMPLES OF WRONG OPENERS (DO NOT GENERATE):\n"
        "✗ \"is there a discount?\" — cheapskate behavior, not whale\n"
        "✗ \"that's too expensive\" — questioning prices, not whale energy"
    ),
    "cold": (
        "TASK: Write your FIRST opening DM to Jasmin. You barely put in any effort. "
        "Send the shortest possible opener — 1 to 4 words MAXIMUM. Lowercase preferred. Just the message.\n"
        "EXAMPLES OF CORRECT OPENERS:\n"
        "✓ \"hey\"\n"
        "✓ \"sup\"\n"
        "✓ \"hi\"\n"
        "EXAMPLES OF WRONG OPENERS (DO NOT GENERATE):\n"
        "✗ \"hey how are you?\" — too many words, too polite\n"
        "✗ \"ur so beautiful!\" — showing enthusiasm, not cold"
    ),
    "simp": (
        "TASK: Write your FIRST opening DM to Jasmin. You've been on her page for an hour "
        "and you're COMPLETELY infatuated. Open with INTENSE flattery and emotional attachment — tell her "
        "she's the most beautiful person you've ever seen, express how obsessed and in love you are. "
        "2-3 sentences. Emotional, earnest, lots of hearts. Just the message.\n"
        "EXAMPLES OF CORRECT OPENERS:\n"
        ...
        "EXAMPLES OF WRONG OPENERS (DO NOT GENERATE):\n"
        "✗ \"hey how are you?\" — too casual, not emotional\n"
        "✗ \"what's your price?\" — transactional, not simp energy"
    ),
}
